...
var require_cancellation = __commonJS((exports2) => {
  ...
  (function(CancellationToken23) {
    ...
    function is2(value) {
      ...
      return candidate && (candidate === CancellationToken23.None || candidate === CancellationToken23.Cancelled || Is.boolean(candidate.isCancellationRequested) && !!candidate.onCancellationRequested);
    }
    CancellationToken23.is = is2;
...
var require_main = __commonJS((exports2) => {
  ...
  function generateRandomPipeName() {
    ...
    if (XDG_RUNTIME_DIR) {
      ...
      result = path10.join(os3.tmpdir(), `vscode-${randomSuffix}.sock`);
    }
...
var require_main2 = __commonJS((exports2) => {
  ...
  (function(Range20) {
    function create(one, two, three, four) {
      if (Is.uinteger(one) && Is.uinteger(two) && Is.uinteger(three) && Is.uinteger(four)) {
        return {start: Position11.create(one, two), end: Position11.create(three, four)};
      } else if (Position11.is(one) && Position11.is(two)) {
    ...
    function is2(value) {
      var candidate = value;
      return Is.objectLiteral(candidate) && Position11.is(candidate.start) && Position11.is(candidate.end);
    }
    Range20.is = is2;
  })(Range19 || (Range19 = {}));
  var Location3;
  (function(Location4) {
    ...
    function is2(value) {
      var candidate = value;
      return Is.defined(candidate) && Range19.is(candidate.range) && (Is.string(candidate.uri) || Is.undefined(candidate.uri));
    }
    Location4.is = is2;
  })(Location3 || (Location3 = {}));
  var LocationLink;
  (function(LocationLink2) {
    ...
    function is2(value) {
      var candidate = value;
      return Is.defined(candidate) && Range19.is(candidate.targetRange) && Is.string(candidate.targetUri) && (Range19.is(candidate.targetSelectionRange) || Is.undefined(candidate.targetSelectionRange)) && (Range19.is(candidate.originSelectionRange) || Is.undefined(candidate.originSelectionRange));
    }
  ...
  (function(ColorInformation2) {
    ...
    function is2(value) {
      var candidate = value;
      return Range19.is(candidate.range) && Color.is(candidate.color);
    }
  ...
  (function(TextEdit7) {
    ...
    function is2(value) {
      var candidate = value;
      return Is.objectLiteral(candidate) && Is.string(candidate.newText) && Range19.is(candidate.range);
    }
    TextEdit7.is = is2;
  })(TextEdit6 || (TextEdit6 = {}));
  ...
  (function(InsertReplaceEdit2) {
    ...
    function is2(value) {
      var candidate = value;
      return candidate && Is.string(candidate.newText) && Range19.is(candidate.insert) && Range19.is(candidate.replace);
    }
  ...
  (function(Hover2) {
    function is2(value) {
      var candidate = value;
      return !!candidate && Is.objectLiteral(candidate) && (MarkupContent3.is(candidate.contents) || MarkedString.is(candidate.contents) || Is.typedArray(candidate.contents, MarkedString.is)) && (value.range === void 0 || Range19.is(value.range));
    }
    Hover2.is = is2;
  })(Hover || (Hover = {}));
  ...
  (function(DocumentSymbol3) {
    ...
    function is2(value) {
      var candidate = value;
      return candidate && Is.string(candidate.name) && Is.number(candidate.kind) && Range19.is(candidate.range) && Range19.is(candidate.selectionRange) && (candidate.detail === void 0 || Is.string(candidate.detail)) && (candidate.deprecated === void 0 || Is.boolean(candidate.deprecated)) && (candidate.children === void 0 || Array.isArray(candidate.children)) && (candidate.tags === void 0 || Array.isArray(candidate.tags));
    }
  ...
  (function(CodeLens3) {
    ...
    function is2(value) {
      var candidate = value;
      return Is.defined(candidate) && Range19.is(candidate.range) && (Is.undefined(candidate.command) || Command5.is(candidate.command));
    }
    CodeLens3.is = is2;
  })(CodeLens2 || (CodeLens2 = {}));
  ...
  (function(DocumentLink2) {
    ...
    function is2(value) {
      var candidate = value;
      return Is.defined(candidate) && Range19.is(candidate.range) && (Is.undefined(candidate.target) || Is.string(candidate.target));
    }
  ...
  (function(SelectionRange2) {
    ...
    function is2(value) {
      var candidate = value;
      return candidate !== void 0 && Range19.is(candidate.range) && (candidate.parent === void 0 || SelectionRange2.is(candidate.parent));
    }
  ...
  var FullTextDocument = function() {
    ...
    FullTextDocument2.prototype.positionAt = function(offset) {
      ...
      if (high === 0) {
        return Position11.create(0, offset);
      }
      while (low < high) {
      ...
      var line = low - 1;
      return Position11.create(line, offset - lineOffsets[line]);
    };
...
var require_windows = __commonJS((exports2, module2) => {
  ...
  function isexe(path10, options, cb) {
    fs5.stat(path10, function(er, stat) {
      cb(er, er ? false : checkStat(stat, path10, options));
    });
  }
  function sync(path10, options) {
    return checkStat(fs5.statSync(path10), path10, options);
  }
});
...
var require_mode = __commonJS((exports2, module2) => {
  ...
  function sync(path10, options) {
    return checkStat(fs5.statSync(path10), options);
  }
  ...
  function isexe(path10, options, cb) {
    ...
    if (!cb) {
      ...
      return new Promise(function(resolve, reject) {
        isexe(path10, options || {}, function(er, is2) {
          if (er) {
            reject(er);
          } else {
            resolve(is2);
    ...
    core(path10, options || {}, function(er, is2) {
      if (er) {
...
var import_coc40 = __toModule(require("coc.nvim"));
...
API.v440 = API2.fromSimpleString("4.4.0");
var api_default = API;
...
var TypeScriptDefinitionProvider = class {
  ...
  async getSymbolLocations(definitionType, document, position, token) {
    ...
    try {
      ...
      return locations.map((location) => Location.fromTextSpan(this.client.toResource(location.file), location));
    } catch {
      return [];
    }
  }
  async provideDefinition(document, position, token) {
    if (this.client.apiVersion.gte(api_default.v270)) {
      ...
      return response.body.definitions.map((location) => {
        const target = Location.fromTextSpan(this.client.toResource(location.file), location);
...
var TypeScriptInlayHintsProvider = class {
  ...
  dispose() {
    ...
    import_coc14.disposeAll(this._disposables);
    this._disposables = [];
...
TypeScriptInlayHintsProvider.minVersion = api_default.v440;
var inlayHints_default = TypeScriptInlayHintsProvider;
...
var FileReferencesCommand2 = class {
  ...
  async execute() {
    ...
    if (response.type !== "response" || !response.body)
      return;
    const locations = response.body.refs.map((r) => Location.fromTextSpan(client.serviceClient.toResource(r.file), r));
    await import_coc17.commands.executeCommand("editor.action.showReferences", doc.uri, import_vscode_languageserver_types2.Position.create(0, 0), locations);
  }
};
...
var ApplyRefactoringCommand2 = class {
  ...
  async execute(document, file2, refactor, action, range) {
    ...
    if (renameLocation) {
      import_coc19.commands.executeCommand("editor.action.rename", document.uri, Position.fromLocation(renameLocation));
    }
    return true;
  }
  ...
  async provideReferences(document, position, context, token) {
    ...
    try {
      ...
      for (const ref of msg.body.refs) {
        ...
        const location = Location.fromTextSpan(url, ref);
...
var TypeScriptReferencesCodeLensProvider = class extends TypeScriptBaseCodeLensProvider {
  resolveCodeLens(codeLens, token) {
    ...
    return this.client.execute("references", args, token, {
      ...
      const locations = response.body.refs.map((reference) => Location.fromTextSpan(this.client.toResource(reference.file), reference)).filter((location) => !(location.uri.toString() === uri && location.range.start.line === codeLens.range.start.line && location.range.start.character === codeLens.range.start.character));
      codeLens.command = {
...
var TagClosing2 = class {
  ...
  dispose() {
    ...
    import_coc22.disposeAll(this._disposables);
    this._disposables = [];
  }
...
var LanguageProvider = class {
  ...
  registerProviders(client, typingsStatus) {
    ...
    this._register(import_coc25.languages.registerCompletionItemProvider(clientId, "TSC", languageIds, new completionItemProvider_default(client, typingsStatus, this.fileConfigurationManager, this.description.id), completionItemProvider_default.triggerCharacters));
    if (this.client.apiVersion.gte(api_default.v230)) {
      this._register(import_coc25.languages.registerCompletionItemProvider(`${this.description.id}-directive`, "TSC", languageIds, new directiveCommentCompletions_default(client), ["@"]));
    }
    ...
    this._register(import_coc25.languages.registerReferencesProvider(languageIds, new references_default(client)));
    this._register(import_coc25.languages.registerHoverProvider(languageIds, new hover_default(client)));
    this._register(import_coc25.languages.registerDocumentHighlightProvider(languageIds, new documentHighlight_default(this.client)));
    this._register(import_coc25.languages.registerSignatureHelpProvider(languageIds, new signatureHelp_default(client), ["(", ",", "<", ")"]));
    this._register(import_coc25.languages.registerDocumentSymbolProvider(languageIds, new documentSymbol_default(client)));
    this._register(import_coc25.languages.registerRenameProvider(languageIds, new rename_default(client, this.fileConfigurationManager)));
    ...
    this._register(import_coc25.languages.registerCodeActionProvider(languageIds, new moduleInstall_default(client), "tsserver"));
    if (this.client.apiVersion.gte(api_default.v380) && typeof import_coc25.languages["registerCallHierarchyProvider"] === "function") {
      this._register(import_coc25.languages.registerCallHierarchyProvider(languageIds, new callHierarchy_default(client)));
    }
    ...
    if (this.client.apiVersion.gte(api_default.v280)) {
      this._register(import_coc25.languages.registerFoldingRangeProvider(languageIds, new folding_default(this.client)));
    ...
    if (this.client.apiVersion.gte(api_default.v240)) {
      this._register(import_coc25.languages.registerCodeActionProvider(languageIds, new refactor_default(client, this.fileConfigurationManager), "tsserver", [import_vscode_languageserver_protocol17.CodeActionKind.Refactor]));
    }
    this._register(import_coc25.languages.registerCodeActionProvider(languageIds, new quickfix_default(client, this.fileConfigurationManager), "tsserver", [import_vscode_languageserver_protocol17.CodeActionKind.QuickFix]));
    this._register(import_coc25.languages.registerCodeActionProvider(languageIds, new importFix_default(this.client.bufferSyncSupport), "tsserver", [import_vscode_languageserver_protocol17.CodeActionKind.QuickFix]));
    ...
    if (this.client.apiVersion.gte(api_default.v206) && conf.get("referencesCodeLens.enable")) {
      this._register(import_coc25.languages.registerCodeLensProvider(languageIds, new referencesCodeLens_default(client, cachedResponse)));
    }
    if (this.client.apiVersion.gte(api_default.v220) && conf.get("implementationsCodeLens.enable")) {
      this._register(import_coc25.languages.registerCodeLensProvider(languageIds, new implementationsCodeLens_default(client, cachedResponse)));
    }
    if (this.client.apiVersion.gte(api_default.v350)) {
      this._register(import_coc25.languages.registerSelectionRangeProvider(languageIds, new smartSelect_default(this.client)));
    }
    if (this.client.apiVersion.gte(api_default.v300)) {
      this._register(new tagClosing_default(this.client, this.description.id));
    }
    if (this.client.apiVersion.gte(api_default.v440) && import_coc25.workspace.isNvim) {
      this._register(new inlayHints_default(this.client, this.fileConfigurationManager, languageIds));
    }
  }
...
var ResourceMap = class {
  ...
  isCaseInsensitivePath(path10) {
    if (isWindowsPath(path10)) {
      return true;
    }
    return path10[0] === "/" && this.onIsCaseInsenitiveFileSystem;
  }
...
var BufferSyncSupport = class {
  constructor(client, modeIds) {
    ...
    const pathNormalizer = (path10) => this.client.toPath(path10);
  ...
  dispose() {
    ...
    import_coc27.disposeAll(this.disposables);
...
var TypeScriptServiceConfiguration = class {
  ...
  get npmLocation() {
    let path10 = this._configuration.get("npm", "");
    if (path10)
      return import_coc29.workspace.expand(path10);
    try {
      path10 = import_which.default.sync("npm");
    } catch (e) {
      return null;
    }
    return path10;
...
var TypeScriptServiceClientHost = class {
  constructor(descriptions, pluginManager) {
    ...
    this.disposables.push(import_coc37.languages.registerWorkspaceSymbolProvider(new workspaceSymbols_default(this.client, allModeIds)));
  ...
  tsDiagnosticToLspDiagnostic(diagnostic) {
    ...
    if (diagnostic.relatedInformation) {
      relatedInformation = diagnostic.relatedInformation.map((o) => {
        let {span, message} = o;
        return {
          location: Location.fromTextSpan(this.client.toResource(span.file), span),
          message
        };
      });
    }
...
var TsserverService = class {
  ...
  dispose() {
    import_coc38.disposeAll(this.disposables);
  }
  restart() {
    if (!this.clientHost)
      return;
...
var PluginManager = class {
  ...
  dispose() {
    import_coc39.disposeAll(this._disposables);
  }
  get plugins() {
    if (!this._plugins) {
